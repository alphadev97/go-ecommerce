...
func GetItemFromCart() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		err := UserCollection.FindOne(ctx, primitive.D{primitive.E{Key: "_id", Value: usert_id}}).Decode(&filtedcart)
		if err != nil {
			log.Println(err)
...
func (app *Application) BuyFromCart() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if userQueryID == "" {
			...
			_ = c.AbortWithError(http.StatusBadRequest, errors.New("user id ids empty"))
		}
